...
export function RegisterForm({ onSuccess, onBack }: RegisterFormProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      // Get detected IP from region context (same as login form)
      ...
      const response = await fetch('/api/auth/register', {
        ...
        body: JSON.stringify({ 
          ...
          password, 
          name,
          clientIP, // Pass frontend-detected IP for accurate region detection
        }),
      })
  ...
  return (
    <Card className="w-full max-w-md">
      ...
      <CardContent className="space-y-4">
        {/* OAuth Register Buttons - Show based on region */}
        ...
        {!regionLoading && regionInfo && regionInfo.ip !== 'unknown' ? (
          <div className="grid grid-cols-1 gap-3">
            {regionInfo.isChina ? (
              // China region: Show WeChat register
              <Button
                type="button"
                variant="outline"
              ...
              // Global region: Show Google register
              <Button
                type="button"
                variant="outline"
